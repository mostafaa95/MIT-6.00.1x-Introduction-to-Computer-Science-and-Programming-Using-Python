...
# especially in cases with very large balances and interest rates. (Note: when your code is 
# running on our servers, there are limits on the amount of computing time each submission 
# is allowed, so your observations from running this experiment on the grading system might 
...
# What is a reasonable lower bound for this payment value? $0 is the obvious 
...
# be greater than what we would've paid in monthly installments, because 
# the interest was compounded on the balance we didn't pay off each month. 
# So a good upper bound for the monthly payment would be one-twelfth of the 
